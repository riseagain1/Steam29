...
public class FlickerGlitch : MonoBehaviour
{
    ...
    public GameObject glitchSprites;
    public GameObject glitchEyes;
    ...
    public void allFixed(){
        ...
        glitchEyes.SetActive(false);

        foreach (Transform child in goodSprites.transform){
                child.GetComponent<SpriteRenderer>().enabled = true;
        }

        foreach (Transform child in glitchSprites.transform){
    ...
    public void allGlitch(){
    
        Good.SetActive(false);
        Glitch.SetActive(true);
        glitchEyes.SetActive(true);
